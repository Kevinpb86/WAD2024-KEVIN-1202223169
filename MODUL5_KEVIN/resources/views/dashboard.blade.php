...
<head>
    ...
    <style>
        /* Header styling */
        .navbar-custom {
            background: linear-gradient(to right, #FF7F00, #FFAA00) !important; /* Gradient from orange to light orange */
        ...
        .navbar-nav .nav-link.active {
            font-weight: bold;
            background-color: #E07B00 !important; /* Slightly darker orange for active link */
        }
        ...
        .welcome-message {
            background-color: #FFE4B5; /* Light orange background for the message */
            padding: 15px;
            border-radius: 5px;
            margin-bottom: 20px;
            font-size: 1.2rem;
            color: #FF7F00; /* Dark orange text color */
        }
    </style>
</head>
<body>
