...
function addStudent()
{
    ...
    if (mysqli_num_rows($ret) == 0) {
        ...
        if (mysqli_affected_rows($conn) > 0) {
            ...
            echo "<script> alert('Data success'); document.location.href = add-student.php </script>";
            exit;
        }
        
    } else {
        echo " <script> alert('Data failed'); document.location.href = add-student.php </script>";
        exit;
    }
}
