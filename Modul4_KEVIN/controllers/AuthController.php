...
class AuthController
{
    ...
    public function login()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            $data_mahasiswa = mysqli_fecth_assoc ($result);
    ...
    private function getJurusan($jurusan){
        ...
        if ($kode_jurusan = 11){
            $jurusan = 'kedokteran';
        } elseif ($kode_jurusan = 12){
            $jurusan = 'psikologi';
        } elseif ($kode_jurusan = 13){
            $jurusan = 'biologi';
        } elseif ($kode_jurusan = 14){
    ...
    private function generateNIM($id_pendaftaran){
        ...
        $result = mysqli_query ($conn, $query);
        $data_pendaftaran = mysqli_ftech_assoc ($result);
        $tahunmasuk = date ('y');
        if ($data_pendaftaran){
    ...
    public function register_step_1()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            $query = "SELECT * FROM pendaftaran WHERE id = 'lulus'";
            $result = mysqli_query ($conn, $query);
            $data_pendaftaran = mysqli_ftech_assoc ($result);
            if ($data_pendaftaran) {
